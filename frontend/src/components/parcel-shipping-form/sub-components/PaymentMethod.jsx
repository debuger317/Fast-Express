    ...
    return (
        ...
        <div class="shadow bg-white dark:bg-gray-700 relative overflow-hidden mr-10 p-5">
            ...
            <div class="flex items-center gap-4 my-3">
                <input {...methods.register("paymentmethod")} class="h-4 w-4" type="radio" name="payment" value="onlinepayment" required/>
                <label for="">Online payment</label>
                <input {...methods.register("paymentmethod")} class="h-4 w-4" type="radio" name="payment" value="cashon" required/>
