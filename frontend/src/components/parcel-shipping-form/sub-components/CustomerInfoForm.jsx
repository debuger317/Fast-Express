        ...
        <div class="px-5 mr-10 mt-6 py-10 bg-white rounded shadow dark:bg-gray-800">
            ...
            <div class="flex flex-col mb-2">
                <div class=" relative ">
                    ...
                    <input {...methods.register("email")} type="text" class="rounded border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent" value={user.email} placeholder="email" required />
                </div>
            </div>
            <div class="flex gap-4 mb-2">
                <div class=" relative ">
                    ...
                    <input {...methods.register("pickupform")} type="text" class=" rounded border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent" placeholder="Jessore" required />
                </div>
                <div class=" relative ">
                    <label for="name-with-label" class="text-gray-700">
                        Pickup to
                    </label>
                    <input {...methods.register("pickupto")} type="text" class=" rounded border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent" placeholder="Dhaka" required />
                </div>
            </div>
            <div class="flex gap-4 mb-2">
                <div class=" relative ">
