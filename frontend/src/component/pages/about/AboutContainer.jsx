...
import exportPicture from '../../../assets/images/expressPicture.jpg';
...
const AboutContainer = () => {
  return (
    <div className="container mx-auto text-center">
      <p className="font-semibold pt-3 text-indigo-600"><Link to="/"><span className="hover:text-gray-600 cursor-pointer">HOME</span></Link> / <span className="hover:text-gray-600 cursor-pointer">ABOUT US</span></p>
      <h2 className="text-3xl pt-16">[ ABOUT OUR <span className="text-indigo-600">COMPANY</span> ]</h2>
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-2 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="Company Logo" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={exportPicture} />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex justify-center text-4xl py-9 text-indigo-500">
