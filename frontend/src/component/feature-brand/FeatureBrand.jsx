...
const FeatureBrand = () => {
  return (
    ...
    <section>
      <div className="container mx-auto py-12">
        ...
        <Swiper slidesPerView={3} spaceBetween={30} slidesPerGroup={3} loop={true} loopFillGroupWithBlank={true} pagination={{
      ...
      }} navigation={true} className="mySwiper mx-auto">
          <SwiperSlide>
          ...
          <SwiperSlide>
            <img className="mx-auto" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDdTaTX5pV2sp-RbRrNk9sgxXfNzaqM1y03g&usqp=CAU" alt="currier" />
          </SwiperSlide>
          <SwiperSlide>
            <img className="mx-auto" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5GyPZsMgguw24Fs1Qi6ac0GfbM0yNuGkUug&usqp=CAU" alt="currier" />
          </SwiperSlide>
          <SwiperSlide>
            <img className="mx-auto" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTjRd_Z3iky5HeK9cBnNwHZz8YNFBwzOPXIg&usqp=CAU" alt="currier" />
          </SwiperSlide>
          <SwiperSlide>
            <img className="mx-auto" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQLHa4XwXjj219B7tJ4VburzssJq0ckiE--4w&usqp=CAU" alt="currier" />
          </SwiperSlide>
          <SwiperSlide>
            <img className="mx-auto" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRV8fac58tbH5l18AR1j2JV9-qCGifChwugdQ&usqp=CAU" alt="currier " />
          </SwiperSlide>
          <SwiperSlide>
